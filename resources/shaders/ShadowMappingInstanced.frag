...
uniform mat4 MV;
uniform ivec3 LightPosition_worldspace;
...
// Returns a random number based on a ivec3 and an int.
float
...
main() {
    ...
    vec3 Vertex_color = vec3(texelFetch(meshColors, int(Vertex_color_id), 0).rgb) / 255.0;
