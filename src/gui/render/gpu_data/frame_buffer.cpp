...
FrameBuffer::FrameBuffer(
    ...
    glTexImage2D(
        GL_TEXTURE_2D, 0, GL_RGBA32F, width_, height_, 0,
        GL_RGBA, GL_FLOAT, 0
    );
    ...
    glTexImage2D(
            GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT, width_, height_, 0,
    ...
    glFramebufferTexture2D(
        GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, render_texture,
        0
    );
