...
struct window_texture_data_t {
    ...
    inline void
    border_size_read(std::array<int, 4> border_size_in) {
        border_size = glm::ivec4(
            border_size_in[0], border_size_in[1], border_size_in[2], border_size_in[3]
        );
    }
    ...
    inline void
    side_lengths_read(std::array<int, 4> side_lengths_in) {
        side_lengths = glm::ivec4(
            side_lengths_in[0], side_lengths_in[1], side_lengths_in[2],
            side_lengths_in[3]
        );
    }
    ...
    inline void
    inner_pattern_size_read(std::array<int, 2> inner_pattern_size_in) {
        inner_pattern_size =
            glm::ivec2(inner_pattern_size_in[0], inner_pattern_size_in[1]);
    }

    inline std::array<std::array<int, 2>, 9>
    texture_regions_write() {
        return {
            std::array<int, 2>({texture_regions[0].x, texture_regions[0].y}),
    ...
    inline void
    texture_regions_read(std::array<std::array<int, 2>, 9> texture_regions_in) {
        texture_regions = std::array<glm::ivec2, 9>(
            {glm::ivec2(texture_regions_in[0][0], texture_regions_in[0][1]),
