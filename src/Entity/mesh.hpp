...
private:
    ...
    void generate_mesh_(VoxelUtility::VoxelObject voxel_object);
 ...
 */
template<class T>
void generate_mesh(T voxel_object,
...
// c c n c c n c c     c c n c c n c c     c c n c c n c c     c c[N]c c n c c
                    ...
                    for (height = 1; j + height < dims[dims_index_2];
                        ...
                        for (unsigned int k = 0; k < width; ++k){
                            // if the direction and color of the original face is
                            // different from the direction and color of the
                            // face currently being tested
                    ...
                    // the last one >> 0 is A
                    glm::vec3 vector_color(red / 255.0, green / 255.0,
                                            blue / 255.0);
