 ...
 *
 * @details Terrain holds all the tiles that
 *
 * exist. It also allows for
 ...
 *
     ...
     * * const UnitPath path type between the two tile positions
     */
     ...
     *
     * @param
     * node_group node group to find position of chunk
     * @return int
     ...
     * * number of macro tiles in x direction
     * @param y_tiles number of macro
     * tiles
     * in y direction
     * @param Area_size_ size of a macro map tile

     * * @param
     * z_tiles number of voxel tiles in z direction
     * @param seed
     * seed of random
     * number generator
     * @param tile_type id of map tile
     * type
     * @param
     * material set of materials used in the world
     *
     * @param biome_data json data
     * that contains biome data
     */
    Terrain(
     ...
     * * @param z_tiles
     * number of voxel tiles in z direction
     * @param seed
     * seed of random number
     * generator
     * @param material set of materials
     * used in the world
     * @param
     * biome_data json data that contains biome
     * data
     * @param grass_grad_data
     * vector that determines grass color from
     * edge
     * distance
     * @param
     * grass_mid gradient index of grass not
     * effected by an edge
     */
    Terrain(
        int x_tiles, int y_tiles, int Area_size_, int z_tiles, int seed,
     ...
     *
     * @return
     * NodeGroup* NodeGroup tile is in
     */
    [[nodiscard]] NodeGroup* get_node_group(const Tile* t);
 ...
 *
     ...
     * * color_id color to set
     * @return true successful change materials is the
     ...
     * @param tile
     * tile
     * to set materials, and color
     * @param mat materials set to
     *
     * @param
     * color_id color id set to
     */
    inline void
     ...
     * @param
     * all_grass
     * set of pointers to tiles that are grass
     */
    inline void
 ...
 */
     ...
     *
     * @return std::set<const NodeGroup

     * * *> set of all NodeGroups
     */
     ...
     * * excitable goals
     * @return std::vector<const NodeGroup *> path to closest
     ...
     * goal
     * goal positions
     * @param search_through available positions for
     * path
     *
     * @param compare way to sort best path
     * @return
     * std::vector<const T *> path
     * optimized by compare
     */
    template <class T>
