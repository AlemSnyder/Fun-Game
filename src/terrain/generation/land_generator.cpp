...
LandGenerator::get_this_stamp() const {
    TileStamp out =
        stamp_generators_[current_region]->get_this_stamp(current_sub_region);
...
TileStamp
JsonToTile::get_volume(glm::imat2x2 center, int Sxy, int Sz, int Dxy, int Dz) const {
...
TileStamp
FromRadius::get_this_stamp(ssize_t current_sub_region) const {
...
TileStamp
FromPosition::get_this_stamp(ssize_t current_sub_region) const {
