...
namespace terrain {
    ...
    class PositionWrapper {
     ...
     public:
        ...
        [[nodiscard]] inline TerrainOffset3 unique_position() const {
            return position_;
        }
    ...
    class NodeGroupWrapper {
     ...
     public:
        ...
        [[nodiscard]] inline glm::vec3 average_position() const {
        ...
        [[nodiscard]] inline std::unordered_set<TerrainOffset3> get_tiles() const {
